  ...
  const skillCategories: Skill[] = [
    {
      ...
      skills: ['Python', 'NumPy', 'Pandas', 'Matplotlib', 'Seaborn', 'Scikit-learn', 'SQL', 'FastAPI', 'SQLAlchemy', 'TensorFlow/Keras']
    },
    {
                ...
                <div className="flex flex-wrap gap-3">
                  {category.skills.map((skill, skillIndex) => (
                    <motion.div
                      ...
                      className="px-4 py-2 bg-gradient-to-r from-lavender/20 to-violet/20 text-lavender border border-lavender/40 rounded-full font-medium text-sm hover:shadow-lg hover:shadow-lavender/20 transition-all duration-300 hover:scale-105 cursor-default"
                    >
                      {skill}
                    </motion.div>
                  ))}
