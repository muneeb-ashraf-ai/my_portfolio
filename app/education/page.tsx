...
const EducationPage: React.FC = () => {
  ...
  const degrees: AcademicDegree[] = [
    ...
    },
    {
      ...
      duration: '2020-2023',
      major: 'Mathematics',
      details: [{ label: 'CGPA', value: '3.37/4.00' }],
    },
    {
  ...
  const courses: Course[] = [
    {
      provider: 'IELTS',
      courses: [
        'Overall Band: 7.0 (CEFR Level C1) - Listening 8.0, Writing 6.5, Speaking 6.0, Reading 7.5',
      ],
    },
    {
      provider: 'National Vocational & Technical Training Commission, Pakistan (NAVTTC)',
      courses: [
        'Artificial Intelligence (Machine Learning & Deep Learning) - Minhaj University, Lahore (Jun 2023 - Dec 2023)',
      ],
    },
    {
      provider: 'Coursera',
                ...
                <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:border-lavender/50 transition-all duration-300">
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                    <div className="flex-1">
                      <h3 className="text-2xl font-bold group-hover:text-lavender transition-colors mb-2 dark:text-white text-midnight">
                        {degree.title}
                      </h3>
          ...
          <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6">
            {courses.map((courseGroup, index) => (
              <motion.div key={index} variants={itemVariants} className="group relative">
                ...
                <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:border-lavender/50 transition-all duration-300">
                  <h3 className="text-2xl font-bold group-hover:text-lavender transition-colors mb-6 dark:text-white text-midnight">
