  ...
  const projects: Project[] = [
    {
      ...
      description:
        'A RESTful API with FastAPI for managing students, courses, and enrollments with JWT authentication.',
    ...
    <div className="min-h-screen pt-32 pb-16 px-6">
      <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden h-full flex flex-col hover:border-lavender/50 transition-all duration-300">
                ...
                <div className="p-6 flex flex-col h-full">
                  {/* Title */}
                  <h3 className="text-xl font-bold mb-3 group-hover:text-lavender transition-colors dark:text-white text-midnight">
                    {project.title}
                  </h3>
        ...
        <motion.div
          ...
          className="mt-16"
        >
          <h2 className="text-3xl font-bold mb-6 dark:text-white text-midnight">
            Other Projects
          </h2>
